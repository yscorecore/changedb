...
{
    public static class FirebirdUtils
    {
        ...
        {
            FbDatabaseModelFactory databaseModelFactory = new FbDatabaseModelFactory();
            var databaseModel = databaseModelFactory.Create(dbConnection, new DatabaseModelFactoryOptions());
            return FromDatabaseModel(databaseModel,dbConnection);
        }
