...
namespace ChangeDB.Agent.Firebird
{
    ...
    public class FirebirdMetadataMigratorTest : IDisposable
    {
        private readonly IMetadataMigrator _metadataMigrator = FirebirdMetadataMigrator.Default;
        private readonly MigrationContext _migrationContext;
        private readonly DbConnection _dbConnection;

        public FirebirdMetadataMigratorTest(DatabaseEnvironment databaseEnvironment)
        {
            ...
            _migrationContext = new MigrationContext
            {
                ...
                {
                    Agent = new FirebirdMigrationAgent(),
                },
